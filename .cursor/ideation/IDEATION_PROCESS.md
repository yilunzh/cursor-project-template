...
```
User: Let's resume the bank-import ideation
...
**Entry:**
- "Let's ideate on [concept description]" - Start new session
- "Resume [project] ideation" - Resume existing
- "List ideation sessions" - Show active ideation sessions
